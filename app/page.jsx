...
const portfolioData = {
    ...
    projects: [
        ...
        {
            title: 'DevTinder',
            description: 'A developer-centric networking platform where engineers can connect, collaborate, and match based on tech stacks and interests.',
            tech: ['React.js', 'Node.js', 'Express.js', 'MongoDB', 'Redux Toolkit', 'Tailwind CSS'],
            githubUrl: 'https://github.com/kk3069kk/DevTinder-FrontEnd',
            projectUrl: 'https://dev-tinder-kiskay.vercel.app/',
            highlights: [
                'Architected a full-stack MERN platform for developer matchmaking, enabling users to swipe, match, and connect with potential collaborators.',
                'Implemented secure JWT-based authentication and cookie-based sessions, ensuring protected access to user profiles and interactions.',
                'Optimized state management using Redux Toolkit and built a premium, responsive UI with Tailwind CSS and DaisyUI.',
            ],
        },
    ],
    skills: {
        ...
        backend: ['Node.js', 'Express.js', 'MongoDB', 'MySQL', 'REST APIs', 'JWT', 'Firebase', 'Razorpay'],
        other: ['Git', 'GitHub', 'Postman', 'Vercel', 'Render', 'DSA', 'OOP', 'DBMS', 'Problem Solving'],
    },
    leadership: [
        {
            role: 'Secretary',
